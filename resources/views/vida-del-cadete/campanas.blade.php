...
<div class="col-lg-8 col-md-8 col-sm-12">
  ...
  <h1 class="text-center text-primary">Campañas</h1>
  <hr>
  <h1></h1>
  ...
  <ul>
    <li>Auxilios en casos de desastres.</li>
    <li>Campañas de reforestación.</li>
    <li>Combate de incendios forestales.</li>
    <li>Auxilio vial al turista.</li>
    <li>Rescate y salvamento.</li>
    <li>Vallas de seguridad.</li>
    <li>Operativo de apoyo a los visitantes en el Nevado de Colima.</li>
  </ul>
  <br>
  ...
  <p class="text-justify">
    <blockquote class="font-small">
      ...
      sea oportuno, eficiente y eficáz. teniendo programadas actividades en caso de incendios,
